...
def train_and_test_prebuilt_keys(base_directory, keys_file, log_file_path="train_val_test_cv_results_anu.txt"):
    """
    ...
    with open(log_file_path, 'w') as log_file:
        ...
        log_file.write("ANU Keys - RESULTS (Single 70/20/10 Split)\n")
        log_file.write("============================================================\n\n")
...
if __name__ == "__main__":
    ...
    keys_file = '/Users\lrm00020\PycharmProjects\KEY-GENERATION-using-DL\ground_keys\ANU.json'       # Replace with your ground truth keys JSON
