...
def train_and_test_prebuilt_keys(base_directory, keys_file, log_file_path="improved_results_with_cv.txt"):
    """
...
if __name__ == '__main__':
    ...
    Gt_keys = 'TBD'
    train_and_test_prebuilt_keys(base_dir, Gt_keys, "train_val_test_cv_results.txt")