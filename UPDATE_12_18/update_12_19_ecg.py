...
def train_and_test_prebuilt_keys(base_directory, keys_file, log_file_path="improved_results_with_cv_ECG.txt"):
    """
...
if __name__ == '__main__':
    ...
    Gt_keys = '/Users\lrm00020\PycharmProjects\KEY-GENERATION-using-DL\ground_keys\ECG_based_key.json'
    train_and_test_prebuilt_keys(base_dir, Gt_keys, "train_val_test_cv_results_ecg.txt")